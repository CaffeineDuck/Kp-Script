from .main.kp_lexer import KpLexer
from .main.kp_parser import KpParser
...
def evaluate(tree):
    global names
    undefined = "Oli says: {0} hasn't been defined!"
    type_error = "Oli says: You can't use '{op}' with types '{obj1}' and '{obj2}'!"
    single_te = "Oli says: You can't use '{op}' with type '{obj}'!"

    try:
        rule = tree[0]
    except TypeError:
        return print("Oli says: Error!!")
    ...
    if rule == "main":
        ...
        try:
            ...
            return print(
                type_error.format(
                    op="*",
                    obj1=get_obj_type(multiplier),
                    obj2=get_obj_type(multiplicand),
                )
            )
    elif rule == "plus":
        ...
        try:
            ...
            return print(
                type_error.format(
                    op="+", obj1=get_obj_type(addend1), obj2=get_obj_type(addend2)
                )
            )
    elif rule == "minus":
        ...
        try:
            ...
            return print(
                type_error.format(
                    op="-", obj1=get_obj_type(minuend), obj2=get_obj_type(subtrahend)
                )
            )
    elif rule == "divide":
        ...
        try:
            ...
            return print(
                type_error.format(
                    op="/", obj1=get_obj_type(dividend), obj2=get_obj_type(divisor)
                )
            )
    elif rule == "mod":
        a = evaluate(tree[1])
        ...
        try:
            ...
            return print(
                type_error.format(op="%", obj1=get_obj_type(a), obj2=get_obj_type(n))
            )
    elif rule == "pow":
        ...
        try:
            ...
            return print(
                type_error.format(
                    op="^", obj1=get_obj_type(target_num), obj2=get_obj_type(exponent)
                )
            )
        ...
        try:
            ...
            return print(f"Oli says: {name} hasn't been defined!")
        newval = oldval + 1
